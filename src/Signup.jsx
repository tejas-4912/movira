...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://movira-backend.onrender.com/api/auth/signup', {
        name,
        email,
        password,
      })
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <p className="text-slate-600 text-center mb-8">Start your recovery journey today</p>
        ...
        <p className="text-center text-slate-600 mt-6">
          ...
          <Link to="/login" className="text-teal-600 font-medium">Sign in</Link>
        </p>
      </div>
    </div>
  )
